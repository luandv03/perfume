...
var mailer_service_1 = require("../../services/mailers/mailer.service");
var MailerController = /** @class */ (function () {
    function MailerController() {
    }
    MailerController.prototype.sendMail = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var dataOrder, to, data, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        dataOrder = req.body.data;
                        to = req.body.to;
